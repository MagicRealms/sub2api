...
var (
	...
	ErrManagedDeployment         = infraerrors.Forbidden("MANAGED_DEPLOYMENT", "This build is managed from MagicRealms/sub2api. Deploy or roll back a tested fork image instead of replacing the running binary.")
