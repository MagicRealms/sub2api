export default {
  ...
  version: {
    ...
    sourceModeHint: 'Checks upstream releases. Built and deployed from the MagicRealms fork.',
    upstreamUpdateAvailable: 'New upstream release available!',
    forkUpdateHint: 'Merge the upstream update into the MagicRealms fork, test it, then deploy.',
    checkFailed: 'Update check failed. Refresh to retry.',
